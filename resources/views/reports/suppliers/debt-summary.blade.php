            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #ecf0f1;">
                        <td style="padding: 0.75rem;">{{ $supplier->name }}</td>
                        <td style="padding: 0.75rem;">${{ number_format($supplier->total_purchases, 2) }}</td>
                        <td style="padding: 0.75rem;">${{ number_format($supplier->total_paid, 2) }}</td>
                        <td style="padding: 0.75rem; text-align: left;"><strong class="text-danger">${{ number_format($supplier->total_debt, 2) }}</strong></td>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" style="padding: 1rem; text-align: center; color: #7f8c8d;">لا توجد ديون</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
